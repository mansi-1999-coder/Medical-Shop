...
namespace Medical_Shop
{
    public partial class Salse_entry_report : Form
    {
        ...
        private void rd_salse_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void Salse_entry_report_SizeChanged(object sender, EventArgs e)
        {
